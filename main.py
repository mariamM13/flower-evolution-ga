...
#             self.draw_flower(x, y, flower)
#
#     def draw_flower(self, cx, cy, flower):
#         size = flower.center_size
#
#         self.canvas.create_rectangle(cx - 6, cy, cx + 6, cy + size * 7,
#                                      fill=self.rgb_to_hex(flower.stem_color),
#                                      outline="")
#
...
#                                     fill=self.rgb_to_hex(flower.petal_color),
#                                     outline="")
#
#         self.canvas.create_oval(cx - size * 1.5, cy - size * 1.5,
...
class FlowerGUI:
    ...
    def on_hover_end(self, index):
        ...
        if self.hover_start is not None and self.hover_flower == index:
            ...
            self.draw_population()  # Redraw to show updated fitness
    ...
    def evolve(self):
        ...
        if total_fitness == 0:
            # If no fitness yet, choose randomly
